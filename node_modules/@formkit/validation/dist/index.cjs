...
function createValidationPlugin(baseRules = {}) {
    return function validationPlugin(node) {
        let availableRules = {
            ...baseRules,
            ...utils.cloneAny(node.props.validationRules),
        };
        ...
        function reboot(newValidation, newRules) {
            if (utils.eq(availableRules, newRules) && utils.eq(validation, newValidation))
                return;
            validation = utils.cloneAny(newValidation);
            availableRules = { ...baseRules, ...utils.cloneAny(node.props.validationRules) };
